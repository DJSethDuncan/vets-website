...
const TEST_URL = '/burial-widget'; // Replace with the correct path
...
describe('The Burial Widget unauthenticed Veteran', () => {
  ...
  it('Provides the appropriate instructions', () => {
    cy.get('div').contains(
      'You can still apply for VA burial benefits by mail, in person at a VA regional office, or with the help of a Veterans Service Officer (VSO) or another accredited representative.',
    );
    cy.get('div').contains(
